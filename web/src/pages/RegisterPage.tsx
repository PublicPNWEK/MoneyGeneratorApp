      ...
      <div className="auth-container">
        <div className="auth-header">
          <div className="auth-logo">
            ...
            <span className="auth-logo-text">Money Generator</span>
          </div>
          <h1 className="auth-title">Create your account</h1>
          <p className="auth-subtitle">Start tracking and growing your income today</p>
        </div>
            ...
            {password && (
              <div className="password-strength">
                ...
                <div className="password-checks">
                  ...
                  <div className={`password-check ${passwordChecks.lowercase ? 'valid' : ''}`}>
                    <Check size={12} />
                    <span>Lowercase</span>
                  </div>
